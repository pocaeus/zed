use editor::{Editor, ScrollTarget};
use gpui::{
    div, px, AnyElement, AppContext, Component, EventEmitter, Pixels, Size, Task, View,
...
pub struct Picker<D: PickerDelegate> {
    ...
    //  list_state: UniformListState, todo!()
...
impl<D: PickerDelegate> EventEmitter for Picker<D> {
    type Event = PickerEvent;
}

impl<D: PickerDelegate> Picker<D> {
    pub fn render(self, _view: &mut D, cx: &mut ViewContext<D>) -> impl Component<D> {
        div()
    }
}
...
impl<D: PickerDelegate> Picker<D> {
    ...
    pub fn new(delegate: D, cx: &mut ViewContext<Self>) -> Self {
        ...
        // let query_editor = cx.build_view({
        //     |cx| {
        ...
        let mut this = Self {
            ...
            delegate,
            max_size: Size::new(px(540.), px(420.)),
            confirmed: false,
    ...
    // where
    //     F: 'static + Fn(&theme::ThemeVariant) -> theme::Picker,
    // {
